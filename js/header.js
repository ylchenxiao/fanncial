...
document.writeln("");
document.writeln("</div>");
document.writeln("<!--banner部分开始-->");
document.writeln("  <div class=\'banner_box\'>");
document.writeln("        <ul class=\'banner_pic\'>");
...
document.writeln("        <div class=\'num\'><ul></ul></div>");
document.writeln("  </div>");
document.writeln("	<script>");
document.writeln("    /*鼠标移过，左右按钮显示*/");
document.writeln("    $(\'.banner_box\').hover(function(){");
document.writeln("        $(this).find(\'.prev,.next\').fadeTo(\'show\',0.1);");
document.writeln("    },function(){");
document.writeln("        $(this).find(\'.prev,.next\').hide();");
document.writeln("    })");
document.writeln("    /*鼠标移过某个按钮 高亮显示*/");
document.writeln("    $(\'.prev,.next\').hover(function(){");
document.writeln("        $(this).fadeTo(\'show\',0.7);");
document.writeln("    },function(){");
document.writeln("        $(this).fadeTo(\'show\',0.1);");
document.writeln("    })");
document.writeln("    $(\'.banner_box\').slide({ titCell:\'.num ul\' , mainCell:\'.banner_pic\' , effect:\'fold\', autoPlay:true, delayTime:700 , autoPage:true });");
document.writeln("    </script>");
document.writeln("    <!-- 代码 结束 -->");
document.writeln("  <!--banner部分结束-->");
